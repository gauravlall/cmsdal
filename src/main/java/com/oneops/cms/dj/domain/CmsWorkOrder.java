 ...
 */
public class CmsWorkOrder extends CmsDpmtRecord implements CmsWorkOrderBase<CmsRfcCI> {
  ...
  @Override
  public List<CmsRfcCI> getPayLoadEntry(String payloadKey) {
  ...
  @Override
  public CmsRfcCI getPayLoadEntryAt(String payloadKey, int indx) {
